...
SAARTHIProject (organicmaps.app) is an open-source project.
...
The Governing Board is the governing body responsible for the overall oversight of the SAARTHIProject. The Board also has the responsibility to ensure the goals, brands, and marks of SAARTHIand community are protected. The Board serves as the final authority within the SAARTHIProject.
